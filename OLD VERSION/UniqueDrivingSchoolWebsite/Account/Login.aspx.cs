        ...
        protected void LoginButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if(DS.Manager.Rows.Count == 1)
                {
                    ...
                    LoginUser.DestinationPageUrl ="/Restricted Access/Manager/ManAccountSettings.aspx";
                }
                else if(DS.Instructor.Rows.Count == 1)
                {
                    Session["Username"] = DS.Instructor.Rows[0]["UserName"];
                    LoginUser.DestinationPageUrl ="/Restricted Access/Instructor/InsAccountSettings.aspx";
                }
                else if(DS.Customer.Rows.Count == 1)
                {
                    Session["Username"] = DS.Customer.Rows[0]["UserName"];
                    LoginUser.DestinationPageUrl = "/Restricted Access/Customer/CusAccountSettings.aspx";                                       
                }
