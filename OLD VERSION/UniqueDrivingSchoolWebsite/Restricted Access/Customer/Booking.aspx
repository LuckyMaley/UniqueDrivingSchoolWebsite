...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="width: 100%; text-align: center; font-family: 'Arial Black'; font-size: larger; color: #000000; height: 59px;" 
        align="center"><h3 align="center">SCHEDULE BOOKING</h3></div>
    
    <div align="center" style="width: 350px; float: left">
        <table>
            <tr>
                <td class="style1">
                    <b>
            ...
            <tr>
                <td class="style1">
                 ...
                 <td class="style2">
                    <b>                        
                         <asp:textbox runat="server" ID="tbLessonDate" Width="104px" 
                         AutoPostBack="false" ReadOnly="True" ></asp:textbox></b><b>
                ...
                <td >
                 ...
                 <td>
                    <b>                        
                         ...
                         SelectedDate="09/30/2019 22:17:56"></asp:calendar>
                    </b>
                 </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2" align="right">
                    <asp:button runat="server" text="Submit" 
                        ...
                        Enabled="False" onclientclick="return confirmation();" /></td>
            </tr>
         </table>
            ...
            ForeColor="#333333" GridLines="None" Width="279px">
                 ...
                 <Columns>
                     ...
                     <asp:BoundField DataField="LessonDate" DataFormatString="{0:d}" 
    ...
    <div align="center" style="width: 70%; float: left; height: 661px;">
        <asp:calendar runat="server" BackColor="White" BorderColor="#3366CC" 
            BorderWidth="1px" CellPadding="1" DayNameFormat="Shortest" Font-Names="Verdana" 
            Font-Size="8pt" ForeColor="#003399" Height="655px" Width="1248px" 
