    ...
    public partial class Booking : System.Web.UI.Page
    {
        ...
        protected void BookingCalender_DayRender(object sender, DayRenderEventArgs e)
        {
            ...
            try
            {
                ...
                bookingTA.FillBy1(DS2.Booking, (int)dataT.Rows[0]["CustomerID"]);
                carTA.FillByCarID(DS2.Car, (int)DS2.Booking.Rows[0]["CarID"]);
                DateTime date;
        ...
        protected void btnSubmitBooking_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if ((DateTime)DS.Booking.Rows[lesson]["LessonDate"] >= DateTime.Now)
                {
                ...
                {
                    Response.Write("<script>alert('That Lesson Date has passed for that lesson number, please try another lesson number');</script>");
                }
            }
            catch (Exception ex)
            {
