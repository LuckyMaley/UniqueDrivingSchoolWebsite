<%@ Page Title="" Language="C#" MasterPageFile="Site1.Master" AutoEventWireup="true" CodeBehind="CusDashboard.aspx.cs" Inherits="UniqueDrivingSchoolWebsite.Restricted_Access.Customer.CusDashboard" %>
...
<SortedDescendingHeaderStyle BackColor="#000065"></SortedDescendingHeaderStyle>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                ...
                SelectCommand="SELECT [LessonNumber], [LessonDate], [LessonTime] FROM [Booking] WHERE (LessonDate = @LessonDate AND ([CustomerID] = @CustomerID))">
                <SelectParameters>
                    <asp:ControlParameter ControlID="Calendar1" Name="LessonDate" 
                        PropertyName="SelectedDate" />
                    <asp:ControlParameter ControlID="Label6" Name="CustomerID" PropertyName="Text" 
                        Type="Int32" />
                </SelectParameters>
            </asp:SqlDataSource>
            <br />
        ...
        <div style="width: 47%; float: left; font-family: 'Arial Rounded MT Bold'; font-size: xx-large; font-weight: bold;" 
            align="left"><asp:Label ID="Label1" runat="server" Text="Customer Name:"></asp:Label>
            <asp:Label ID="Label2" runat="server" Text="Label"></asp:Label>
            <br />
            <asp:Label ID="Label3" runat="server" Text="Course:"></asp:Label>
            <asp:Label ID="Label4" runat="server" Text="Label"></asp:Label>
            <br />
            Lessons:<asp:Label ID="Label5" runat="server" Text="Label"></asp:Label>
