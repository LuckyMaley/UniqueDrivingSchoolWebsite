        ...
        <div id="AccountSetting" align="center" 
            ...
            <div  style=" width: 250px; font-size: x-large;" 
                ...
                Account Settings</div>
                    ...
                    <table><tr>
                    <td colspan ="2" class="style4" align="center" valign="middle">
                    <div align="center" style="width: 467px">
            ...
            <tr><td class="style6"></td><td class="style2" align="center">
                <asp:fileupload runat="server" ID="fileup" Visible="False" 
                    CssClass="form-control" Width="312px">
                </asp:fileupload>
            </td>
            </tr>
            <tr><td colspan="2" align="center" class="style7">
                
                        <asp:Label ID="Label3" runat="server"></asp:Label>
                        <br />
                
                        <asp:button runat="server" text="Upload" ID="btnUpload" Width="97px" 
            ...
            <hr />
                        ...
                        <p id = "bot" align="right" 
                            style="border: medium solid #000000; height:56px; width: 628px;" >
