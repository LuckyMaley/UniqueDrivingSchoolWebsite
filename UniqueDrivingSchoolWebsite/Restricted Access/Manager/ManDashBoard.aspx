<%@ Page Title="" Language="C#" MasterPageFile="~/Restricted Access/Manager/Site3.Master" AutoEventWireup="true" CodeBehind="ManDashBoard.aspx.cs" Inherits="UniqueDrivingSchoolWebsite.Restricted_Access.Manager.ManDashBoard" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div align="center" class="container img-rounded" >
...
<SortedDescendingHeaderStyle BackColor="#000065"></SortedDescendingHeaderStyle>
        ...
        <div style="width: 49%; float: left; font-family: 'Arial Rounded MT Bold'; font-size: x-large; font-weight: bold;" 
            align="left"><asp:Label ID="Label1" runat="server" Text="Manager Name:"></asp:Label>
            <asp:Label ID="Label2" runat="server" Text="Label"></asp:Label>
            
            
            <br />
            <asp:Label ID="Label4" runat="server" Text="Registered Customers:"></asp:Label>
            <asp:Label ID="Label5" runat="server" Text="0"></asp:Label>
            <br />
            <asp:Label ID="Label6r" runat="server" Text="Instructors:"></asp:Label>
            <asp:Label ID="Label7" runat="server" Text="0"></asp:Label>
            <br />
            <asp:Label ID="Label8" runat="server" Text="Cars:"></asp:Label>
